...
const demoItems = [
    { link: '#', text: 'Workshops', image: '/Events/Shortfilm.jpg' },
    { link: '#', text: 'Screenings', image: '/Events/MeesayaMurukku.jpg' },
    { link: '#', text: 'Festivals', image: '/Events/Retrograde.JPG' },
    { link: '#', text: 'Talks', image: '/Events/Shortfilm.jpg' },
    { link: '#', text: 'Collabs', image: '/Events/MeesayaMurukku.jpg' }
];
