...
class InfiniteGridMenu {
    ...
    discInstances: DiscInstances | null = null;
    viewportSize = vec2.create();


    constructor(canvas: HTMLCanvasElement, items: InfiniteMenuItem[], onActiveItemChange: (index: number) => void, onMovementChange: (isMoving: boolean) => void, onInit: ((instance: InfiniteGridMenu) => void) | null = null, scale = 1.0) {
    ...
    resize() {
        ...
        if (this.gl && resizeCanvasToDisplaySize(this.gl.canvas as HTMLCanvasElement)) this.gl.viewport(0, 0, this.gl.drawingBufferWidth, this.gl.drawingBufferHeight);
