...
// preloadImages removed for lazy loading optimization
...
const Masonry = ({
    ...
    useLayoutEffect(() => {
        // Run animations as soon as grid is ready
                                    ...
                                    <img
                                        ...
                                        onLoad={(e) => {
                                            ...
                                            setImageDimensions(prev => {
                                                ...
                                                next.set(item.img, { width: img.naturalWidth, height: img.naturalHeight });
                                                return next;
                                            });
                                        }}
                                    />
