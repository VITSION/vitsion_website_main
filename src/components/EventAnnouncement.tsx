...
const EventAnnouncement = () => {
    const [data, setData] = useState(homeData.eventAnnouncement);

    useEffect(() => {
        // Fetch is commented out to prioritize local home.json data
        /*
    ...
    return (
        <div className="relative w-full max-w-6xl mx-auto min-h-[500px] md:min-h-[600px] h-auto rounded-3xl overflow-hidden border border-white/10 shadow-2xl my-12 group md:mx-auto">
            ...
            <img
                ...
                loading="lazy"
                decoding="async"
                className="absolute inset-0 w-full h-full object-cover object-center opacity-50 transition-transform duration-700 group-hover:scale-105"
            />
