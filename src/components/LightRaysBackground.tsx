...
const LightRaysBackground = React.memo(
  ({ className }: LightRaysBackgroundProps) => {
    const paths = [
    ...
    return (
      ...
      >
        ...
        >
          ...
          {paths.map((path, index) => (
            <motion.path
              key={`animated-${index}`}
              d={path}
              stroke="url(#beamGradientHighlight)"
              strokeWidth="0.5"
        ...
        {/* Corner vignette for cinematic effect */}
