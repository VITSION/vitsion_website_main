...
export default function Films() {
  ...
  return (
    <>
      ...
      {selectedFilm && (
        <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black/80 backdrop-blur-sm p-3 md:p-4 animate-in fade-in duration-300">
          <div className="relative w-full max-w-[95vw] bg-[#141414] rounded-2xl overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300 border border-white/10 flex flex-col md:flex-row max-h-[92vh]">
            ...
            <div className="relative flex-shrink-0 bg-black/20 flex items-center justify-center">
              <img
                ...
                className="block w-full md:w-auto h-auto max-h-[35vh] md:max-h-[90vh] max-w-full md:max-w-[55vw] object-contain"
              />
            </div>

            {/* Content Area */}
            <div className="w-full md:w-[400px] relative p-5 md:p-10 flex flex-col justify-center items-start gap-4 md:gap-6 bg-[#141414] overflow-y-auto">

              <h2 className="text-xl md:text-3xl font-bold text-white tracking-wide uppercase leading-tight text-left">
                {selectedFilm.title}
              </h2>
              ...
              <div className="w-full flex items-center gap-4">
                <Button
                  ...
                  className="flex-1 h-11 px-6 bg-red-600 hover:bg-red-700 text-white font-bold text-base rounded-lg transition-all shadow-lg flex items-center justify-center gap-2"
                >
            ...
            <button
              ...
              className="absolute top-3 right-3 z-[100] p-2 bg-black/50 hover:bg-black/80 text-white rounded-full transition-colors border border-white/10"
