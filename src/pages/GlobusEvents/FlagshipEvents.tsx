...
const FlagshipEvents = () => {
    ...
    const events: GlobusEvent[] = [
        ...
        {
            id: 3, title: "WHAT IF ?", desc: "Flip the script and rewrite the rules. Dare to imagine the unexpected and own the stage.", date: "25 MAR", time: "11:40 AM", venue: "AB-1 701",
            poster: "/Globus/globus_posters/24.png", infoImages: ["/Globus/globus_posters/25.png", "/Globus/globus_posters/26.png"]
        },
        {
            id: 4, title: "MOVIE MINDS", desc: "Test your cinematic knowledge under pressure. Only the fastest and sharpest minds will win.", date: "25 MAR", time: "11:40 AM", venue: "AB-1 702",
            ...
            <div className="max-w-7xl mx-auto relative z-10 w-full mb-auto">
                ...
                <div className="flex items-start gap-5 sm:gap-6 mb-16">
                    ...
                    <div className="flex flex-col">
                        <h1 className="text-5xl sm:text-6xl md:text-7xl font-black tracking-tight text-[#A6FF00] drop-shadow-[0_0_25px_rgba(166,255,0,0.4)] uppercase leading-none" style={{ fontFamily: "'Arial Black', Arial, sans-serif" }}>Compete</h1>
                        <div className="flex items-center gap-4 mt-3 md:mt-4 ml-1">
                            ...
                            <p className="text-white/80 text-[10px] sm:text-xs md:text-sm font-semibold uppercase tracking-[0.4em]" style={{ fontFamily: "Arial, sans-serif" }}>Where pressure meets passion</p>
                        </div>
                    </div>
                </div>
