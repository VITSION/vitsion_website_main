...
export default function Team() {
    ...
    const teamMembers = [
        ...
        },
        {
            ...
            image: "/teams/Mohana_Ramanan_D.webp"
        },
        {
            id: 3,
            name: "Gurusreeram",
        ...
        },
        {
            ...
            image: "/teams/Thanmayya_Vinod.webp"
        }
    ];
                ...
                <div className="w-full max-w-7xl px-4 flex flex-col items-center">
                    ...
                    <div className="w-full flex justify-center mb-2">
                        {[{
                            ...
                            image: "/teams/IMG_20250521_114651 - Vineeth Radhakrishnan.webp"
                        }].map((member) => (
                            <div
                                key={member.id}
                            ...
                            >
                                ...
                                <h3 className="text-white text-xl md:text-[1.5vw] font-bold mb-2 md:mb-[0.5vw] tracking-tight text-center break-words w-full transition-colors duration-300 group-hover:text-gray-100">{member.name}</h3>
                                <p className="text-gray-500 text-xs md:text-[0.9vw] text-center uppercase tracking-wider font-semibold mb-4 md:mb-[1vw] transition-colors duration-300 group-hover:text-gray-400">{member.role}</p>
