...
const coreMembers = [
    {
        ...
        description: 'Core',
        image: '/teams/Core/rajarajeswari.webp'
    },
    {
        link: '#',
        title: 'Keerthana Anil Sankar',
        description: 'Core',
        image: '/teams/Core/keerthana.webp'
    },
    {
        link: '#',
        title: 'Vishaal Dharsan Prakash',
        description: 'Core',
        image: '/teams/Core/vishaal.webp'
    },
    {
        link: '#',
        title: 'Sam Rozario D',
    ...
    },
    {
        ...
        title: 'Ragavi G S',
        description: 'Core',
        image: '/teams/Core/ragavi.webp'
    },
    {
        link: '#',
        title: 'Aaditya Iniavan',
        description: 'Core',
        image: '/teams/Core/aaditya.webp'
    },
    {
        link: '#',
        title: 'Harinisri Vijayakumar',
        description: 'Core',
        image: '/teams/Core/harinisri.webp'
    },
    {
        link: '#',
        title: 'Keith Anthony',
        description: 'Core',
        image: '/teams/Core/keith.webp'
    },
    {
        link: '#',
        title: 'Shreya J',
        description: 'Core',
        image: '/teams/Core/shreya.webp'
    }
];
