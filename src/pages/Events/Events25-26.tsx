...
export default function Events25_26() {
    ...
    const [eventItems, setEventItems] = useState<EventItem[]>(eventsData as EventItem[]);

    useEffect(() => {
        // Fetch is commented out to prioritize local events.json data as requested
        /*
    ...
    return (
        <>
            ...
            <div
                className={`fixed top-0 right-0 h-full w-full md:w-[80vw] lg:w-[60vw] z-[2001] transform transition-transform duration-500 ease-in-out ${showBento ? 'translate-x-0' : 'translate-x-full'} overflow-hidden`}
            >
                <button
                        ...
                        >
                            {eventsRow1.map((item, i) => (
                                <div
                                    ...
                                    className="film-card event-card-mobile"
                                    style={{
                                        width: "240px",
                                        padding: "14px",
                                        borderRadius: "8px",
