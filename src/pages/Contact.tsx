                    ...
                    <div className="space-y-8 animate-fade-in-up">
                        ...
                        <div className="space-y-6 pt-4">
                            ...
                            <a
                                ...
                                className="flex items-center gap-4 text-lg text-gray-300 group transition-colors hover:text-[#FBBF24]"
                            >
                                <div className="p-3 bg-white/5 rounded-lg group-hover:bg-[#FBBF24]/10 transition-colors shrink-0">
                                    <Mail className="w-6 h-6" />
                                </div>
                                <span className="break-all text-sm md:text-xl">vitsionmoviemakers@gmail.com</span>
                            </a>
                        </div>
                    </div>
